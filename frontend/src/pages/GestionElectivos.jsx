...
export default function GestionElectivos() {
  ...
  const guardarCambios = async () => {
    try {
      ...
      if (sumaCupos !== parseInt(formData.cupos)) {
        alert(`La suma de la distribución (${sumaCupos}) no coincide con los cupos totales (${formData.cupos})`);
        setGuardando(false);
        return;
      }
  ...
  const aprobar = async (id) => {
    try {
      ...
      alert("Error al aprobar el electivo");
    }
  };
  ...
  const agregarCarrera = () => {
    ...
    if (carreraDisponible) {
      ...
      alert("No hay más carreras disponibles");
    }
  };
      ...
      {electroSeleccionado && (
        ...
        >
          <motion.div
            ...
            className={`max-w-3xl w-full rounded-2xl shadow-2xl p-8 max-h-[90vh] overflow-y-auto ${
              darkMode ? "bg-gray-800 text-gray-100" : "bg-white text-gray-900"
            }`}
          >
              ...
              <div className="flex-1">
                {modoEdicion ? (
                  <input
                    ...
                    className={`text-2xl font-bold text-purple-500 mb-2 w-full border-b-2 border-purple-500 bg-transparent focus:outline-none ${
                ...
                {modoEdicion ? (
                  <input
                    ...
                    className={`text-lg w-full border-b bg-transparent focus:outline-none ${
                      darkMode ? "text-gray-400 border-gray-600" : "text-gray-600 border-gray-300"
                    }`}
                    ...
                    {formData.distribucion_cupos?.map((cupo, index) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          className={`w-32 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 ${
                            darkMode
                              ? "bg-gray-600 border-gray-500 text-gray-100"
                              : "bg-white border-gray-300 text-gray-900"
                          }`}
